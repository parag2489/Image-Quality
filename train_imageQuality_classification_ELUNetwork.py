...
logger 			= '/media/AccessParag/Code/DNN_imageQuality_classification_Mar31_ELUNetwork.txt'
...
model.add(Convolution2D(384, 3, 3, border_mode='same', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(MaxPooling2D(pool_size=(2,2)))  # 16 X 16

# ------------------------------------------------------------------------------------------------------------------------------------------------ #

model.add(Convolution2D(384, 1, 1, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(ZeroPadding2D(padding=(1,1)))
model.add(Convolution2D(384, 2, 2, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(ZeroPadding2D(padding=(1,1)))
model.add(Convolution2D(640, 2, 2, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(MaxPooling2D(pool_size=(2,2)))
model.add(Dropout(0.1))

# ------------------------------------------------------------------------------------------------------------------------------------------------ #

model.add(Convolution2D(640, 1, 1, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(ZeroPadding2D(padding=(1,1)))
model.add(Convolution2D(768, 2, 2, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(ZeroPadding2D(padding=(1,1)))
model.add(Convolution2D(768, 2, 2, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(ZeroPadding2D(padding=(1,1)))
model.add(Convolution2D(768, 2, 2, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
...
model.add(Convolution2D(768, 1, 1, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(ZeroPadding2D(padding=(1,1)))
model.add(Convolution2D(896, 2, 2, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(ZeroPadding2D(padding=(1,1)))
model.add(Convolution2D(896, 2, 2, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(MaxPooling2D(pool_size=(2,2)))
...
model.add(Convolution2D(896, 1, 1, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(ZeroPadding2D(padding=(1,1)))
model.add(Convolution2D(1024, 2, 2, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(ZeroPadding2D(padding=(1,1)))
model.add(Convolution2D(1024, 2, 2, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(MaxPooling2D(pool_size=(2,2)))
...
model.add(Convolution2D(1024, 1, 1, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(Convolution2D(1152, 2, 2, border_mode='valid', trainable=True, init=initialization, W_regularizer=l2(regularizer), subsample=(1, 1), activation = "relu"))
model.add(MaxPooling2D(pool_size=(2,2)))
...
model.add(Flatten())
model.add(Dense(1152, trainable=True, init=initialization, W_regularizer=l2(regularizer), activation = "softmax"))
model.add(Dropout(0.5))
